...
function StudentManage() {
     ...
     const [newStudent, setNewStudent] = useState({ stu_name: '', reg_no: '', course_id: '', category: '', semester: '', section: '', batch: '', active_sem: '' });
               ...
               <table className="student-table">
                    <thead>
                         <tr>
                              ...
                              <th className="student-header">Course Id</th>
                              <th className="student-header">Category</th>
                              <th className="student-header">Semester</th>
                    ...
                    <div className="modal-overlay">
                         <div className="modal-content">
                              ...
                              <input
                                   ...
                                   onChange={handleAddInputChange}
                              />
                              <select id="dropdown" value={newStudent.course_id} onChange={handleAddInputChange}>
                                   <option value="">--Select--</option>
                                   <option value="option1">Option 1</option>
                                   <option value="option2">Option 2</option>
                                   <option value="option3">Option 3</option>
                              </select>
                              <select id="dropdown" value={newStudent.category} onChange={handleAddInputChange}>
                                   <option value="">--Select--</option>
                                   <option value="option1">Option 1</option>
                                   <option value="option2">Option 2</option>
                                   <option value="option3">Option 3</option>
                              </select>
                              <select id="dropdown" value={newStudent.semester} onChange={handleAddInputChange}>
                                   <option value="">--Select--</option>
                                   <option value="option1">Option 1</option>
                                   <option value="option2">Option 2</option>
                                   <option value="option3">Option 3</option>
                              </select>
                              <select id="dropdown" value={newStudent.section} onChange={handleAddInputChange}>
                                   <option value="">--Select--</option>
                                   <option value="option1">Option 1</option>
                                   <option value="option2">Option 2</option>
                                   <option value="option3">Option 3</option>
